...
class StudentInfoController extends Controller
{
    ...
    public function getStudentEditDetailsByStudentCode(Request $request)
{
    try {
    ...
    if ($request->isMethod('post')) {
        ...
        return response()->json([
            'status'    => true,
            'encrypted' => Crypt::encryptString($request->student_code)
        ]);
    }
    ...
    if (!$request->filled('student_code')) {
        return view(
            ...
            compact('data', 'showDetails')
        );
    }

    try {
        $studentCode = Crypt::decryptString($request->student_code);
    } catch (DecryptException $e) {
        return redirect()
            ->route('student.edit')
            ->with('error', 'Invalid student code');
    }

    $student_basic_info = StudentInfo::where('school_id_fk', $schoolId)
    ...
    if (!$student_basic_info) {
        ...
        //    3. ================= Facility ========================
        // ====================================================== */
        // $facility = StudentFacilityAndOtherDetails::where('school_id_fk', $schoolId)
        //     ->where('student_code', $studentCode)
        //     ->first();
        ...
        //    4. ================= Vocational ======================
        // ====================================================== */
        // $vocational = StudentVocationalDetails::where('school_id_fk', $schoolId)
        //     ->where('student_code', $studentCode)
        //     ->first();

        // $data['vocational'] = $vocational ? [
        //     'trade_sector' => $vocational->vocational_trade_sector_code_fk,
        //     'job_role'     => $vocational->vocational_job_role_code_fk,
        // ] : null;
        ...
        //    5. ================= Contact =========================
        // ====================================================== */
        // $student_contact = StudentContactInfo::where('school_id_fk', $schoolId)
        //     ->where('student_code', $studentCode)
        //     ->first();
        ...
        //     'stu_mobile_no' => $student_contact->stu_mobile_no,
        //     'stu_email'     => $student_contact->stu_email,
        //     'stu_address'   => $student_contact->stu_contact_address,
        // ] : null;

        // /* ======================================================
        //    6. ================= Bank ============================
        // ====================================================== */
        // $student_bank_details = EntryStudentBankInfo::where('school_id_fk', $schoolId)
        //     ->where('student_code', $studentCode)
        //     ->first();

        // $data['student_bank_details'] = $student_bank_details ? [
        //     'bank_ifsc'       => $student_bank_details->bank_ifsc,
        //     'stu_bank_acc_no' => $student_bank_details->stu_bank_acc_no,
        // ] : null;
        ...
        //    7. ================= Additional ======================
        // ====================================================== */
        // $student_additional_details = StudentAdditionalInfo::where('school_id_fk', $schoolId)
        //     ->where('student_code', $studentCode)
        //     ->first();

        // $data['student_additional_details'] = $student_additional_details ? [
        //     'cur_class_marks_percent' => $student_additional_details->cur_class_marks_percent,
        //     'attendention_cur_year'   => $student_additional_details->attendention_cur_year,
        // ] : null;

        /* ======================================================
           FINAL RETURN (AS YOU ASKED)
        ====================================================== */
        $showDetails = true;
        return view(
            'src.modules.student_entry_update.Student_edit',
...
//     // if ($request->filled('student_code')) {
//     //     $student = DB::table('bs_student_basic_info')
...
//         // ================= Basic Info =================
//         $student_basic_info = StudentInfo::where('student_code', $studentCode)->first();
...
//         // ================= Enrollment =================
//         $student_enrollment_info = StudentEnrollmentInfo::where('student_code', $studentCode)->first();

//         $data['enrollment_info'] = $student_enrollment_info ? [
//             'admission_no'            => $student_enrollment_info->admission_no,
//             'status_pre_year'         => $student_enrollment_info->status_pre_year,
//             'prev_class_appeared_exam'=> $student_enrollment_info->prev_class_appeared_exam,
//             'prev_class_exam_result'  => $student_enrollment_info->prev_class_exam_result,
...
//         // ================= Facility =================
//         $facility = StudentFacilityAndOtherDetails::where('student_code', $studentCode)->first();
//         $data['facility'] = $facility ? $facility : null;

//         // ================= Vocational =================
//         $vocational = StudentVocationalDetails::where('student_code', $studentCode)->first();
//         $data['vocational'] = $vocational ? $vocational : null;

//         // ================= Contact =================
//         $contact = StudentContactInfo::where('student_code', $studentCode)->first();
//         $data['student_contact'] = $contact ? $contact : null;

//         // ================= Bank =================
//         $bank = EntryStudentBankInfo::where('student_code', $studentCode)->first();
//         $data['student_bank_details'] = $bank ? $bank : null;

//         // ================= Additional =================
//         $additional = StudentAdditionalInfo::where('student_code', $studentCode)->first();
//         $data['student_additional_details'] = $additional ? $additional : null;
...
//         Log::error('Error getStudentEntryByStudentCode: '.$e->getMessage());
