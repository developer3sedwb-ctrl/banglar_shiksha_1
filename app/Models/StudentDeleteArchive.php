...
class StudentDeleteArchive extends Model
{
    use HasFactory, SoftDeletes;
    protected $table = 'bs_student_delete_archive';
    protected $fillable = [
        'id',
        'district_code_fk',
        'subdivision_code_fk',
    ...
    {
        return $this->hasOne(ReasonForStudentDeletionnMaster::class, 'id', 'delete_reason_code_fk');
    }
