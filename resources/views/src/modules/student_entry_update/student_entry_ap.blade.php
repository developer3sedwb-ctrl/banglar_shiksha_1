    ...
    <div class="input-group">
        ...
        <div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="tab3-tab">
          <form method="POST" action="#">
            ...
            <div class="row mt-3">
                <div class="col-md-6">
                  <label class="form-label small">Facilities provided to the student (for the year of filling data) *</label>
                  <select name="facilities_provided_for_the_yeear" class="form-select">
                    <option value="">-Please Select-</option><option>YES</option><option>NO</option>
                  </select>
                </div> 
                <div class="col-md-6">
                  <label class="form-label small">Free Text Book</label>
                  <select name="free_textbook" class="form-select">
                    <option value="">-Please Select-</option><option>YES</option><option>NO</option>
                  </select>
                </div>

                <div class="col-md-6">
                  <label class="form-label small">Free Transport Facility</label>
                  <select name="free_transport_facility" class="form-select">
                    <option value="">-Please Select-</option><option>YES</option><option>NO</option>
                  </select>
                </div>

                <div class="col-md-6">
                  <label class="form-label small">Free Host Facility</label>
                  <select name="free_host_facility" class="form-select">
                    <option value="">-Please Select-</option><option>YES</option><option>NO</option>
                  </select>
                </div>
                ...
                <div class="col-md-6">
                  <label class="form-label small">Free Uniforms</label>
                  <select name="free_uniforms" class="form-select">
                    <option value="">-Please Select-</option><option>YES</option><option>NO</option>
                  </select>
                </div>

                <div class="col-md-6">
                  <label class="form-label small">Free Escort</label>
                  <select name="free_escort" class="form-select">
                    <option value="">-Please Select-</option><option>YES</option><option>NO</option>
                  </select>
                </div>

                <div class="col-md-6">
                  <label class="form-label small">Free Shoe</label>
                  <select name="free_shoe" class="form-select">
                    <option value="">-Please Select-</option><option>YES</option><option>NO</option>
                  </select>
                </div>

                <div class="col-md-6">
                  <label class="form-label small">Free Exercise Book</label>
                  <select name="free_exercise_book" class="form-select">
                    <option value="">-Please Select-</option><option>YES</option><option>NO</option>
                  </select>
                </div>
                  <div class="col-md-6">
                  <label class="form-label small">Complete Set of Free Books</label>
                  <select name="complete_free_books" class="form-select">
                    <option value="">-Please Select-</option><option>YES</option><option>NO</option>
                  </select>
                </div>
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-6">
                  <label class="form-label small">Name & Code of State Scholarship</label>
                  <input type="text" name="state_scholarship_name" class="form-control">
                </div>

                <div class="col-md-6">
                  <label class="form-label small">Scholarship Amount (per annum)</label>
                  <input type="number" name="state_scholarship_amount" class="form-control">
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                  ...
                  <select name="other_scholarship" class="form-select">
                    <option value="">-Select-</option><option>YES</option><option>NO</option>
                  </select>
                </div>
                ...
                <div class="col-md-6">
                  <label class="form-label small">Scholarship Amount (per annum)</label>
                  <input type="number" name="other_scholarship_amount" class="form-control">
                </div>
            </div>
            ...
            <div class="row mt-3">
              ...
              <div class="col-md-4">
                ...
                <select name="gifted_math" class="form-select">
                  <option value="">-Select-</option><option>YES</option><option>NO</option>
                </select>
              </div>
              ...
              <div class="col-md-4">
                ...
                <select name="gifted_language" class="form-select">
                  <option value="">-Select-</option><option>YES</option><option>NO</option>
                </select>
              </div>

              <div class="col-md-4">
                <label class="form-label small">Science</label>
                <select name="gifted_science" class="form-select">
                  <option value="">-Select-</option><option>YES</option><option>NO</option>
                </select>
              </div>

              <div class="col-md-4 mt-3">
                <label class="form-label small">Technical</label>
                <select name="gifted_technical" class="form-select">
                  <option value="">-Select-</option><option>YES</option><option>NO</option>
                </select>
              </div>

              <div class="col-md-4 mt-3">
                <label class="form-label small">Sports</label>
                <select name="gifted_sports" class="form-select">
                  <option value="">-Select-</option><option>YES</option><option>NO</option>
                </select>
              </div>

              <div class="col-md-4 mt-3">
                <label class="form-label small">Art</label>
                <select name="gifted_art" class="form-select">
                  <option value="">-Select-</option><option>YES</option><option>NO</option>
                </select>
              </div>
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-6">
                  <label class="form-label small">Whether provided mentors</label>
                  <select name="provided_mentors" class="form-select">
                    <option value="">-Select-</option><option>YES</option><option>NO</option>
                  </select>
                </div>

                <div class="col-md-6">
                  <label class="form-label small">Whether participated in Nurturance Camps (State)</label>
                  <select name="state_nurturance" class="form-select">
                    <option value="">-Select-</option><option>YES</option><option>NO</option>
                  </select>
                </div>

                <div class="col-md-6">
                  <label class="form-label small">Whether participated in Nurturance Camps (National)</label>
                  <select name="national_nurturance" class="form-select">
                    <option value="">-Select-</option><option>YES</option><option>NO</option>
                  </select>
                </div>

                <div class="col-md-6">
                  <label class="form-label small">Has the student appeared in State/National Competitions?</label>
                  <select name="participated_competitions" class="form-select">
                    <option value="">-Select-</option><option>YES</option><option>NO</option>
                  </select>
                </div>
                ...
                <div class="col-md-6">
                  <label class="form-label small">Child participates in NCC/NSS/Scouts/Guides?</label>
                  <select name="ncc_nss_guides" class="form-select">
                    <option value="">-Select-</option><option>YES</option><option>NO</option>
                  </select>
                </div>

                <div class="col-md-6">
                  <label class="form-label small">Getting free education as per RTE Act?</label>
                  <select name="rte_free_education" class="form-select">
                    <option value="">-Select-</option><option>YES</option><option>NO</option>
                  </select>
                </div>

                <div class="col-md-6">
                  <label class="form-label small">Whether child is Homeless?</label>
                  <select name="homeless" class="form-select">
                    <option value="">-Select-</option><option>YES</option><option>NO</option><option>NOT APPLICABLE</option>
                  </select>
                </div>

                <div class="col-md-6">
                  <label class="form-label small">Special Training Facility Provided?</label>
                  <select name="special_training" class="form-select">
                    <option value="">-Select-</option><option>YES</option><option>NO</option>
                  </select>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                  <label class="form-label small">Capable of handling digital devices?</label>
                  <select name="able_to_handle_devices" class="form-select">
                    <option value="">-Select-</option><option>YES</option><option>NO</option>
                  </select>
                </div>

                <div class="col-md-6">
                  <label class="form-label small">Whether child has access to Internet?</label>
            ...
            <div class="form-actions text-end mt-3">
              <button class="btn btn-secondary me-2" type="button"
                      data-bs-toggle="tab" data-bs-target="#tab2">Previous</button>

              <button class="btn btn-success" type="button"
                      data-bs-toggle="tab" data-bs-target="#tab5">Next</button>
            </div>
