                ...
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    ...
                    <select name="gender" class="form-select" required>
                      ...
                      @foreach($dropdowns['genders'] as $val => $label)
             ...
             <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <select name="mother_tongue" class="form-select">
                        ...
                        @foreach($dropdowns['mother_tongues'] as $val => $label)
                            <option value="{{ $val }}">{{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="mb-3">
                  ...
                  <select name="social_category" class="form-select" required>
                      <option value="">-Please Select-</option>
                      @foreach($dropdowns['social_categories'] as $val => $label)
                          <option value="{{ $val }}">{{ $label }}</option>
                      @endforeach
                  </select>
                  </div>
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    ...
                    <select name="religion" class="form-select" required>
                      <option value="">-Please Select-</option>
                      @foreach($dropdowns['religions'] as $val => $label)
                          <option value="{{ $val }}">{{ $label }}</option>
                      @endforeach
                    </select>
                  </div>
              ...
              <div class="col-md-6">
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group">
                   ...
                   <select name="cwsn" class="form-select">
                      <option value="">-Please Select-</option>
                          @foreach($dropdowns['nationalities'] as $val => $label)
                              <option value="{{ $val }}">{{ $label }}</option>
                          @endforeach
                    </select>
                  </div>
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    ...
                    <select name="blood_group" class="form-select">
                      <option value="">-Please Select-</option>
                        @foreach($dropdowns['blood_groups'] as $val => $label)
                            <option value="{{ $val }}">{{ $label }}</option>
                        @endforeach
                    </select>
                  </div>
                  ...
                  <div class="input-group">
                    <span class="input-group-text"><i class="bx bx-link-alt"></i></span>
                     <select name="relationship_with_guardian" class="form-select">
                      <option value="">-Please Select-</option>
                        @foreach($dropdowns['relationship_with_guardian'] as $val => $label)
                            <option value="{{ $val }}">{{ $label }}</option>
                        @endforeach
                    </select>
                  </div>
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    ...
                    <select name="family_income" class="form-select">
                      <option value="">-Please Select-</option>
                              @foreach($dropdowns['family_annual_incomes'] as $val => $label)
                                  <option value="{{ $val }}">{{ $label }}</option>
                              @endforeach
                    </select>
                  </div>
               ...
               <div class="mb-3">
                  ...
                  <div class="input-group">
                   ...
                   <select name="guardian_qualifications" class="form-select">
                      <option value="">-Please Select-</option>
                        @foreach($dropdowns['guardian_qualifications'] as $val => $label)
                      <option value="{{ $val }}">{{ $label }}</option>
                        @endforeach
                    </select>
                  </div>
