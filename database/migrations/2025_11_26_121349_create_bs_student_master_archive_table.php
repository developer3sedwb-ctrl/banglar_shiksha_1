...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // ---------------------------------------------------
        DB::statement("
            CREATE TABLE bs_student_master_archive (
        ...
        foreach ($districts as $district) {
            DB::statement("
                CREATE TABLE bs_student_master_archive_{$district}
                PARTITION OF bs_student_master_archive
                FOR VALUES IN ({$district});
            ");

            // Index helpful for most queries
            DB::statement("
                CREATE INDEX idx_stu_school_archive_{$district}
                ON bs_student_master_archive_{$district} (school_code_fk,student_code);
            ");
        }
        ...
        // ---------------------------------------------------
        Schema::table('bs_student_master_archive', function (Blueprint $table) {
    ...
    {
        DB::statement("DROP TABLE IF EXISTS bs_student_master_archive CASCADE;");
    }
};
