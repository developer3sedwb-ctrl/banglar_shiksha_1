...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // ---------------------------------------------------
        DB::statement("
            CREATE TABLE bs_student_delete_history_archive (
        ...
        // ---------------------------------------------------
        DB::statement("
            CREATE UNIQUE INDEX uniq_delete_student_history_aadhaar_global
            ON bs_student_delete_history_archive (district_code_fk,aadhaar_number)
        ...
        // ---------------------------------------------------
        DB::statement("
            ALTER TABLE bs_student_delete_history_archive
            ADD CONSTRAINT uniq_delete_student_history_identity
            UNIQUE (
                district_code_fk,
                studentname,
                fathername,
        ...
        // ---------------------------------------------------
        Schema::table('bs_student_delete_history_archive', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('bs_student_delete_history_archive');
    }
};
