...
return new class extends Migration
{
    public function up(): void
    {
        /* -----------------------------------------------------
         ...
         ----------------------------------------------------- */
        DB::statement("
            CREATE TABLE IF NOT EXISTS bs_student_facilities_archive (
        ...
        foreach ($districts as $d) {
            ...
            $part = "bs_student_facilities_archive_{$d->id}";

            DB::statement("
                CREATE TABLE IF NOT EXISTS $part
                PARTITION OF bs_student_facilities_archive
                FOR VALUES IN ({$d->id});
            ");
    ...
    {
        DB::statement("DROP TABLE IF EXISTS bs_student_facilities_archive CASCADE;");
    }
};
