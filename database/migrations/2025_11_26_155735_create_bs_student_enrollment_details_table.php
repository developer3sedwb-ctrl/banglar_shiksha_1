...
return new class extends Migration
{
    ...
    {
        Schema::create('bs_student_enrollment_details', function (Blueprint $table) {
            $table->bigIncrements('id');
            // School FK
            $table->unsignedBigInteger('student_id_fk');
            $table->foreign('student_id_fk')
                ->references('id')
                ->on('bs_student_master');
            ...
            $table->date('admission_date')->nullable(); // ADDED
            ...
            $table->smallInteger('prev_class_appeared_exam')->nullable(); // ADDED
            $table->smallInteger('prev_class_exam_result')->nullable(); // ADDED
            $table->decimal('prev_class_marks_percent', 10, 2)->nullable(); // ADDED
            // Days attended
            $table->smallInteger('attendention_pre_year')->nullable(); // ADDED
            // Previous class details
            $table->smallInteger('pre_roll_number');
    ...
    {
        Schema::dropIfExists('bs_student_enrollment_details');
    }
};
