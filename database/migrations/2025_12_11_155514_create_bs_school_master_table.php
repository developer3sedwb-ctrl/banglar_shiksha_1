...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('bs_school_master', function (Blueprint $table) {
            ...
            // GEO COORDINATES
            $table->decimal('latdeg', 10, 2)->default(0)->nullable();
            $table->decimal('latmin', 10, 2)->default(0)->nullable();
            $table->decimal('latsec', 10, 2)->default(0)->nullable();
            $table->decimal('londeg', 10, 2)->default(0)->nullable();
            $table->decimal('lonmin', 10, 2)->default(0)->nullable();
            $table->decimal('lonsec', 10, 2)->default(0)->nullable();
            ...
            $table->unsignedSmallInteger('year_upgrd_pri_to_upri')->default(0)->nullable();
            $table->unsignedSmallInteger('year_upgrd_upri_to_sec')->default(0)->nullable();
            $table->unsignedSmallInteger('year_upgrd_sec_to_hsec')->default(0)->nullable();
        ...
        Schema::table('bs_school_master', function (Blueprint $table) {
            ...
            // School Structure
            $table->foreign('school_category_code_fk')->references('id')->on('bs_category_master');
            $table->foreign('school_management_code_fk')->references('id')->on('bs_management_master');
            $table->foreign('school_type_code_fk')->references('id')->on('bs_type_master');
            ...
            $table->foreign('secondary_affiliation_board_code_fk')->references('id')->on('bs_board_council_master');
            $table->foreign('council_affiliation_board_code_fk')->references('id')->on('bs_board_council_master');
            $table->foreign('secondary_exam_name_fk')->references('id')->on('bs_exam_name_master');
            $table->foreign('council_exam_name_fk')->references('id')->on('bs_exam_name_master');

            // Curriculum
            $table->foreign('curriculum_followed_fk')->references('id')->on('bs_curriculum_followed_master');
        });
    }
